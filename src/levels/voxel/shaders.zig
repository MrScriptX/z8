...
pub const MeshComputeShader = struct {
    ...
    pub fn deinit(self: *MeshComputeShader, r: *Renderer) void {
    ...
    pub fn build(self: *MeshComputeShader, allocator: std.mem.Allocator, shader: []const u8, r: *Renderer) !void { 
    ...
    pub fn write(self: *MeshComputeShader, allocator: std.mem.Allocator, pool: *descriptors.DescriptorAllocator2, resources: *const Resource, r: *const Renderer) compute.Instance {
        const data =  compute.Instance {
            .pipeline = &self.pipeline,
            .descriptor = pool.allocate(allocator, r._device, self.layout, null),
        };
